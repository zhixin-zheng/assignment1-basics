...
import cs336_basics
from cs336_basics.train_utils import TrainConfig, TrainLogger
...
def train_model(config: TrainConfig):
    ...
    with TrainLogger(log_dir="logs", config=config, use_wandb=True) as tracker:
...
def main():
    ...
    parser.add_argument('--eps', type=float, help='Epsilon for AdamW optimizer.')
